              ...
              <el-descriptions :column="2" size="smaller" class="mt-4">
                ...
                <el-descriptions-item label="当前状态：">
                  <el-select v-model="statusValue2" style="width: 200px">
                    ...
                    <el-option label="已遗弃" value="5" />
                  </el-select>
                </el-descriptions-item>
                <el-descriptions-item label="创建者：">zihang001</el-descriptions-item>
                <el-descriptions-item label="创建时间：">2024-09-02</el-descriptions-item>
                <el-descriptions-item label="负责人：">zihang001</el-descriptions-item>
                <el-descriptions-item label="确认人：">zihang001</el-descriptions-item>
                <el-descriptions-item label="最近更新时间：">2024-09-29</el-descriptions-item>
                <el-descriptions-item label="关联项目：">敏捷研发项目</el-descriptions-item>
              </el-descriptions>
              <div class="functionButton" style="display: flex; justify-content: flex-end">
                <el-button type="primary">提测试需求</el-button>
              </div>
              <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
                <el-tab-pane label="Bug详情描述" name="CaseExecute">
